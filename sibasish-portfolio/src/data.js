export const me = {
  ...
  summary: "Backend and platform engineer specializing in high-scale payments infrastructure, observability systems, and distributed systems architecture.",
  highlights: [
    "Reduced settlement processing time by 75% through intelligent queuing and scheduling algorithms",
    "Built RBI-compliant tokenization platform and led Tap & Pay feature from proof-of-concept to general availability",
    "Introduced comprehensive observability stack with OpenTelemetry + SigNoz, Kafka event mart, and Redis circuit breaker patterns"
  ],
...
export const projects = [
  {
    ...
    period: "CRED",
    company: "CRED",
    blurb: "High-throughput settlement system processing ~$200M TPV daily with resilient queues, intelligent retries, and seamless bank payout integrations.",
    longDescription: "Architected and built a comprehensive settlement system handling $200M+ in daily transaction volume with intelligent queuing mechanisms, exponential backoff retry strategies, and seamless bank payout integrations. Implemented smart scheduling algorithms that reduced settlement processing time by 75% while maintaining 99.9% system uptime. The system features an event-driven architecture with MySQL for transactional consistency and SQS for reliable message processing.",
  ...
  },
  {
    ...
    longDescription: "Developed an RBI-compliant tokenization platform with merchant-level token management, ensuring PCI DSS compliance and full regulatory adherence. Led Tap & Pay feature development from proof-of-concept to general availability, implementing EMV contactless payment flow for Android NFC with sub-100ms response times. The platform handles secure token lifecycle management and enables seamless payment processing.",
  ...
  },
  {
    ...
    longDescription: "Implemented an end-to-end observability platform using OpenTelemetry for distributed tracing across microservices and SigNoz for real-time monitoring dashboards. Built a Kafka-based event mart for analytics and introduced Redis circuit breaker patterns for improved system resilience. Achieved over 50% latency reduction through performance optimization and proactive monitoring.",
  ...
  },
  {
    ...
    blurb: "Enterprise-grade data mart tool for a Fortune Top 10 client with OAuth2/OpenID Connect SSO and distributed processing capabilities.",
  ...
  },
  {
    ...
    period: "TWID PAY",
    company: "TWID PAY",
    blurb: "Real-time event streaming pipeline processing 1M+ events daily with Kafka, ClickHouse, and automated data quality monitoring.",
    longDescription: "Built a robust event streaming pipeline using Apache Kafka for real-time data ingestion and ClickHouse for analytical workloads. Implemented a schema registry for data governance, automated data quality checks, and real-time alerting for pipeline health. The system processes over 1 million events daily with 99.99% data accuracy and enables real-time business intelligence dashboards.",
...
export const experience = [
  { company: "TWID PAY", role: "Lead Developer", period: "Feb 2024 – Present", bullets: [
    ...
    "Implemented growth optimization features contributing to approximately 20% GMV increase",
    "Platform Engineering: Deployed OpenTelemetry + SigNoz observability, Redis circuit breaker patterns, and Kafka event mart",
  ...
  { company: "CRED", role: "Backend Engineer (Settlement & Tokenization)", period: "Jun 2019 – Jun 2023", bullets: [
    ...
    "Implemented bank payout integrations with approximately 60% per-settlement cost reduction",
    "Led Tap & Pay feature from proof-of-concept to general availability and re-architected merchant tokenization platform",
    "Achieved over 50% latency improvements through deep performance debugging and optimization"
  ]},
  { company: "Mu Sigma Inc.", role: "Backend Developer", period: "Jan 2019 – Jun 2019", bullets: [
    "Led a team of 3 engineers developing Data Mart analytics tool for Fortune Top 10 client",
